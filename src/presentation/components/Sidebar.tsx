import { MessageSquare, Users, Settings, BarChart3, UserCog, LogOut, UsersRound } from 'lucide-react';
...
export function Sidebar({ selectedView, onViewChange }: SidebarProps) {
  ...
  const menuItems = [
    { id: 'dashboard' as const, icon: BarChart3, label: 'Dashboard', permission: Permission.VIEW_DASHBOARD },
    { id: 'conversations' as const, icon: MessageSquare, label: 'Conversas', permission: Permission.VIEW_CONVERSATIONS },
    { id: 'customers' as const, icon: UsersRound, label: 'Clientes', permission: Permission.VIEW_CUSTOMERS },
