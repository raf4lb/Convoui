...
export class MetricsRepository implements IMetricsRepository {
  ...
  async getDetailedPerformance(): Promise<AttendantDetailedPerformance[]> {
    return Promise.resolve([
      { name: 'João Silva', total: 45, active: 3, resolved: 42, avgTime: '2m 15s', satisfaction: 4.8 },
      { name: 'Ana Costa', total: 38, active: 2, resolved: 36, avgTime: '2m 45s', satisfaction: 4.9 },
      { name: 'Carlos Mendes', total: 52, active: 1, resolved: 51, avgTime: '2m 30s', satisfaction: 4.6 },
      { name: 'Mariana Santos', total: 29, active: 0, resolved: 29, avgTime: '3m 10s', satisfaction: 4.7 },
    ]);
  }
}
